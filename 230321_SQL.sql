...
-- Inner-join 방식으로 급여(SAL)이 2000 초과인 사원들의 부서 정보, 사원정보를 출력
-- (1) 오라클 SQL
SELECT D.DEPTNO
	, D.DNAME
	, E.EMPNO
...
-- Natural-join 각 부서별 평균 급여, 최대 급여, 최소 급여, 사원 수를 출력
SELECT DEPTNO
	, D.DNAME
...
-- 모든 부서 정보와 사원 정보를 부서정보를 기준으로 조인(Right-join)
SELECT D.DEPTNO
	, D.DNAME 
	, E.EMPNO
	, E.ENAME
...
-- 부서정보, 사원정보, 급여 등급 정보를 JOIN하여 각 사원의 직속 상관의 정보를
